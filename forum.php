...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="left">
  ...
  <tr> 
          ...
          <td VALIGN="middle" ALIGN="left" HEIGHT="50">
            <table BORDER="0" CELLSPACING="0" CELLPADDING="0">
              <tr>
                ...
                <td ALIGN="left"> <a HREF="Forum/index.php" target="_parent" CLASS="hauptlinksAktiv">Forum</a> </td>
              </tr>
          </table></td>
        </tr>
        <tr>
    ...
    <td valign="top" nowrap align="left" colspan="2" height="350"> 
      <table width="100%" border="0" cellspacing="1" cellpadding="10" height="350" bgcolor="#BEBEBE">
        <tr> 
          <td bgcolor="#FFDF7D" height="10" > <div align="center"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Leider 
              zur Zeit noch Baustelle.</font></div></td>
        </tr>
        <tr> 
